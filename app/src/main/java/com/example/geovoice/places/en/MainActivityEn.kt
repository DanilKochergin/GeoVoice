...
import com.example.geovoice.databinding.ActivityMainEnBinding
...
class MainActivityEn : AppCompatActivity() {
    lateinit var binding: ActivityMainEnBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        binding = ActivityMainEnBinding.inflate(layoutInflater)
        ...
        binding.tv1.setOnClickListener {
            markVisited("place1")
            val intent = Intent(this, FirstPlaceEn::class.java)
            startActivity(intent)
        }
        binding.tv2.setOnClickListener {
            markVisited("place2")
            val intent = Intent(this, SecondPlaceEn::class.java)
            startActivity(intent)
        }
        binding.tv3.setOnClickListener {
            markVisited("place3")
            val intent = Intent(this, ThirdPlaceEn::class.java)
            startActivity(intent)
        }
    }
